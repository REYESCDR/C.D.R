...
let biografia = await conn.fetchStatus('15102104796' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `💨 ꧁༒REYES༒꧂`, dev, 'azazelreyes2007@gmail.com', `🇻🇪 El Salvador`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Un Bot 🐉`, `${packname}`, `📵 No Hacer Spam`, `Planeta Martes 🌍`, `https://github.com/REYESCDR/C.D.R`, biobot]
], m)
